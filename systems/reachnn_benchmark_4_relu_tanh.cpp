...
int main(int argc, char *argv[])
{
	...
	Interval init_x0(0.26 - w, 0.26 + w), init_x1(0.09 - w, 0.09 + w), init_x2(0.26 - w, 0.26 + w), init_u(0); //w=0.01
	...
	string nn_name = "systems_with_networks/reachnn_benchmark_4/nn_4_relu_tanh";
	...
	ofstream result_output("./outputs/reachnn_benchmark_4_relu_tanh_" + to_string(if_symbo) + ".txt");
	...
	plot_setting.plot_2D_interval_MATLAB("reachnn_benchmark_4_relu_tanh_" + to_string(if_symbo), result);
