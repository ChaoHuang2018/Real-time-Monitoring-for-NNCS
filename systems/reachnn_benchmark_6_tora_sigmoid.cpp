...
int main(int argc, char *argv[])
{
	...
	string nn_name = "systems_with_networks/reachnn_benchmark_6_tora/nn_6_tora_sigmoid";
	...
	ofstream result_output("./outputs/reachnn_benchmark_6_tora_sigmoid_" + to_string(if_symbo) + ".txt");
	...
	plot_setting.plot_2D_interval_MATLAB("reachnn_benchmark_6_tora_sigmoid_" + to_string(if_symbo), result);
