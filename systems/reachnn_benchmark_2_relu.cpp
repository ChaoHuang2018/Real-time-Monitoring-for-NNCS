...
int main(int argc, char *argv[])
{
	...
	string nn_name = "systems_with_networks/reachnn_benchmark_2/nn_2_relu";
	...
	ofstream result_output("./outputs/reachnn_benchmark_2_relu_" + to_string(if_symbo) + ".txt");
	...
	plot_setting.plot_2D_interval_MATLAB("reachnn_benchmark_2_relu_" + to_string(if_symbo), result);
