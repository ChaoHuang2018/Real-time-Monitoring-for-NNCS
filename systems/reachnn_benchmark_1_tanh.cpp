...
int main(int argc, char *argv[])
{
	...
	ofstream result_output("./outputs/reachnn_benchmark_1_tanh_" + to_string(if_symbo) + ".txt");
	...
	plot_setting.plot_2D_interval_MATLAB("reachnn_benchmark_1_tanh_" + to_string(if_symbo), result);
