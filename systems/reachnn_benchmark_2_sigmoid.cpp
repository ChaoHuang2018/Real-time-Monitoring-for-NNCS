...
int main(int argc, char *argv[])
{
	...
	// setting.setAdaptiveStepsize(1e-6, 0.01, order);
	...
	Interval init_x0(0.8 - w, 0.8 + w), init_x1(0.8 - w, 0.8 + w), init_u(0);
	...
	string nn_name = "systems_with_networks/reachnn_benchmark_2/nn_2_sigmoid";
	...
	ofstream result_output("./outputs/reachnn_benchmark_2_sigmoid_" + to_string(if_symbo) + ".txt");
	...
	plot_setting.plot_2D_octagon_MATLAB("reachnn_benchmark_2_sigmoid_" + to_string(if_symbo), result);
