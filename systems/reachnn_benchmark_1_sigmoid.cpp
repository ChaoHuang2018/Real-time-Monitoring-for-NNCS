...
int main(int argc, char *argv[])
{
	...
	string nn_name = "systems_with_networks/reachnn_benchmark_1/nn_1_sigmoid";
	...
	ofstream result_output("./outputs/reachnn_benchmark_1_sigmoid.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("reachnn_benchmark_1_sigmoid", result);
