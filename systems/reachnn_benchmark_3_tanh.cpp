...
int main(int argc, char *argv[])
{
	...
	string nn_name = "systems_with_networks/reachnn_benchmark_3/nn_3_tanh";
	...
	plot_setting.plot_2D_octagon_MATLAB("reachnn_benchmark_3_tanh_" + to_string(if_symbo), result);
